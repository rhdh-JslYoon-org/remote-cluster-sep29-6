...
2) Go to the `Data Science Projects` section and access your application's project named `remote-cluster-sep29-6`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `remote-cluster-sep29-6-notebook`.
...
5) In the terminal, run `cd remote-cluster-sep29-6` to navigate to your sample app's directory.
